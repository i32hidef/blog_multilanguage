...
elgg_register_event_handler('init', 'system', 'blog_multilanguage_init');

/**
 * Init blog plugin.
 */
function blog_multilanguage_init() {
	
	elgg_register_library('elgg:blog_multilanguage', elgg_get_plugins_path() . 'blog_multilanguage/lib/blog.php');

	// add a site navigation item
	$item = new ElggMenuItem('blog', elgg_echo('blog:blogs'), 'blog/all');
	elgg_register_menu_item('site', $item);

	elgg_register_event_handler('upgrade', 'upgrade', 'blog_multilanguage_run_upgrades');
	...
	// routing of urls
	elgg_register_page_handler('blog', 'blog_multilanguage_page_handler');

	// override the default url to view a blog object
	elgg_register_entity_url_handler('object', 'blog', 'blog_multilanguage_url_handler');

	// notifications
	register_notification_object('object', 'blog', elgg_echo('blog:newpost'));
	elgg_register_plugin_hook_handler('notify:entity:message', 'object', 'blog_multilanguage_notify_message');

	// add blog link to
	elgg_register_plugin_hook_handler('register', 'menu:owner_block', 'blog_multilanguage_owner_block_menu');
	...
	// register actions
	$action_path = elgg_get_plugins_path() . 'blog_multilanguage/actions/blog';
	...
	// entity menu
	elgg_register_plugin_hook_handler('register', 'menu:entity', 'blog_multilanguage_entity_menu_setup');

	// ecml
	elgg_register_plugin_hook_handler('get_views', 'ecml', 'blog_multilanguage_ecml_views_hook');
}
 ...
 * @return NULL
 */
function blog_multilanguage_page_handler($page) {

	elgg_load_library('elgg:blog_multilanguage');
 ...
 */
function blog_multilanguage_url_handler($entity) {
 ...
 */
function blog_multilanguage_owner_block_menu($hook, $type, $return, $params) {
 ...
 */
function blog_multilanguage_entity_menu_setup($hook, $type, $return, $params) {
 ...
 */
function blog_multilanguage_ecml_views_hook($hook, $entity_type, $return_value, $params) {
 ...
 */
function blog_multilanguage_on_activate() {
 ...
 */
function blog_multilanguage_run_upgrades() {
